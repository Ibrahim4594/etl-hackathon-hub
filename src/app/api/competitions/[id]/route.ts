...
const competitionUpdateSchema = z.object({
  ...
  customSubmissionFields: z.array(z.object({
    id: z.string(),
  ...
  prizeConfirmed: z.boolean().optional(),
  targetParticipants: z.array(z.string()).optional(),
...
export async function GET(
  ...
  const [competition] = await db
    .select({
      ...
      accessCode: competitions.accessCode,
